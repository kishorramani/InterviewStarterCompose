    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = "Settings & Device Inspector",
        ...
        Column(
            ...
            if (info != null) {
                Card(
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        MetricRow(icon = Icons.Default.PhoneAndroid, label = "Operating System", value = info.osVersion)
            ...
            OutlinedCard(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(
                        text = "Clear Local Room Cache",
                        style = MaterialTheme.typography.titleSmall.copy(fontWeight = FontWeight.SemiBold)
                    )
                    Spacer(modifier = Modifier.height(4.dp))
                    Text(
                        text = "Clears non-bookmarked cached articles from Room database without removing your saved favorites.",
                    ...
                    Button(
                        ...
                        Text(if (uiState.isClearingCache) "Clearing..." else "Clear Unsaved Cache")
                    }
                }
            }
