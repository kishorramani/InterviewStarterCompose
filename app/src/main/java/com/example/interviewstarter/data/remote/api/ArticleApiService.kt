    ...
    companion object {
        fun getMockArticles(): List<ArticleDto> {
            return listOf(
                ArticleDto(
                    id = 1000000001L,
                    title = "Jetpack Compose 2026: Next-Gen Compiler & Performance Enhancements",
                    description = "Jetpack Compose has introduced groundbreaking compiler optimizations, SubcomposeLayout reductions, and automated memory recycling for heavy lists.",
                    bodyMarkdown = "Jetpack Compose continues to modernize Android UI development. The latest releases streamline recomposition skipping with stronger stability heuristics, near-zero layout overhead, and tight integration with Material 3 Adaptive layouts.",
                    url = "https://developer.android.com/jetpack/compose",
                    coverImage = "https://picsum.photos/seed/compose1/800/450",
                    socialImage = "https://picsum.photos/seed/compose1/800/450",
                    user = ArticleDto.UserDto(name = "Android Developer Relations"),
                    tagList = listOf("android", "compose", "kotlin", "mobile"),
